          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button v-if="productAmount > 1" type="button" aria-label="Убрать один товар"
                @click.prevent="productAmount -= 1" style="cursor: pointer">
                  <svg width="12" height="12" fill="currentColor">
                    <use xlink:href="#icon-minus"></use>
                  </svg>
                </button>
                <button v-else-if="productAmount === 1" type="button" aria-label="Убрать один товар"
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            GPS синхронизируется с датчиками по ANT+, объединяя полученную с них
            информацию. Данные отображаются на дисплее, а также сохраняются на смартфоне.
          ...
          <p>
            ...
            информация: интенсивность, скорость вращения педалей, пульс и т.д. (датчики
            не входят в комплект поставки). Корпус велокомпьютера имеет степень защиты
            от влаги IPX7. Это означает, что устройство не боится пыли, а также
